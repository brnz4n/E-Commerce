...
export function Hero() {
  return (
    // Usamos uma div wrapper para conter o Header e a Section
    <div className="relative">
      <Header />
      
      {/* Mantemos a section com a altura mínima de 90vh para preencher a tela */}
